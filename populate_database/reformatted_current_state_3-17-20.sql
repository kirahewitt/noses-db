...
INSERT INTO `Users` (`UserID`, `Username`, `Password`, `Initials`, `isAdmin`, `Affiliation`, `Email`, `ObsID`) 
VALUES (1,'iorourke@calpoly.edu','password','IR',3,'iorourke@calpoly.edu','iorourke@calpoly.edu',2),
       (2,'iminarov@calpoly.edu','password','IM',3,'iminarov@calpoly.edu','iminarov@calpoly.edu',1);
UNLOCK TABLES;
